...
class NsubjFilter(UDFilter):
        ...
        for child_idx, child in enumerate(tree):
            if child["deprel"] == "nsubj":
                ...
                if self.set_copula:
                    ...
                    main_verb_idx = verb_idx if cop_idx is None else cop_idx
                ...
                if self.transfer_head_child_features:
                    for feature in ["Number", "Person", "Gender"]:
                        if (feature not in head_features) and (
                            feature in child_features
                        ):
    ...
    def fetch_copula(
        ...
        str, Optional[int], Optional[Dict[str, str]], Optional[str], Optional[str]
    ]:
